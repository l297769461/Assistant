...
namespace Assistant.BLL
{
    ...
    {
        private readonly Assistant.DAL.orderinifo dal = new Assistant.DAL.orderinifo();
        public orderinifo()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<Assistant.Model.orderinifo> GetList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Assistant.Model.orderinifo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Assistant.Model.orderinifo> GetList(string strWhere, int pageindex, int pagesize, string orderby, bool orderbytype, out int total)
        {
